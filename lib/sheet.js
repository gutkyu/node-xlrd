...
module.exports = function Sheet(book, position, name, number){
    ...
    */
	...
	self.cellRaw = function( rowx, colx){
	...
	*/
	...
	Object.defineProperty(self, 'rowCount', {get:function(){return _nrows;}});
	Object.defineProperty(self, 'colCount', {get:function(){return _ncols;}});
